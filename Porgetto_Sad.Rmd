...
La distanza di Chebycev è anche nota come distanza "L-infinito" e si
...
```{r}
clusplot(mpg_2, cut_mediana, color=TRUE, shade=TRUE, labels=3, lines=0, xlab="Mediana", ylab = "Distanza", main = "Mediana")
```
