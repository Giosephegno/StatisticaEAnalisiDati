...
***`siamo arrivati a momenti campionari`***
...
sono correlate ma negativamente. Infine osservando i valori di *year*
possiamo affermare che è correlata in modo molto debole con tutte le
variabili.
...
Il modello di regressione lineare semplice è un tipo di modello di
...
una variabile indipendente (chiamata anche variabile esplicativa o
predictor).
...
|                | regressione semplice | regressione multiplo |
+================+======================+======================+
