...
knitr::include_graphics("densita.jpg")
```
...
knitr::include_graphics("normale.jpg")
```
...
```{r fig.align = 'center', pressure, echo=FALSE, fig.cap="A caption", out.width = '100%'}

knitr::include_graphics("3sigma.jpg")
```
