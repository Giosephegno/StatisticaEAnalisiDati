...
#### Grafico a dispersione ros è  bona

Grafico a dispersione: questo grafico mostra la relazione tra due
variabili numeriche. Ad esempio, puoi utilizzare il grafico a
dispersione per visualizzare come i valori di "displ" sono correlati ai
valori di un'altra variabile numerica, come "cty" (città) o "hwy"
(autostrada). Ecco come puoi creare un grafico a dispersione con la
libreria ggplot2 in R:
...
2.  Boxplot: il boxplot è un grafico che mostra la distribuzione di una
    variabile numerica. È utile per individuare eventuali valori anomali
    o fuori dal range di normalità. Ecco come puoi creare un boxplot con
    la libreria ggplot2 in R:
...
3.  Density plot: il density plot è un grafico che mostra la
    distribuzione di una variabile numerica sotto forma di curva di
    densità. È utile per ottenere una panoramica della forma della
    distribuzione dei dati. Ecco come puoi creare un density plot con la
    libreria ggplot2 in R:
