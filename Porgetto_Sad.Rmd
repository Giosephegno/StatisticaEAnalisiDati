...
```{r}
p9 <- ggplot(data = mpg, mapping = aes(cyl)) + geom_bar(stat = "count", fill= "white", col = "black") + ggtitle("Variabile cyl")
...
Per valutare l'accuratezza del modello di regressione lineare multipla,
è possibile utilizzare diverse misure, come il coefficiente di
determinazione (R²) o l'errore quadratico medio (MSE).
