...
$y_1, y_2, . . . , y_n$. La covariana campionaria tra le due variabili
...
covarianza. Quando $r_{xy} > 0$ si dice che le variabili sono correlate
positivamente, se $r_{xy} < 0$ le variabili sono correlate negativamente
e, infine, se $r_{xy} = 0$ le variabili sono non correlate.
...
$$t = \frac{(\overline \beta_{j})}{s . \sqrt(c_{}jj)} \sim t_{n-p-1}$$la
