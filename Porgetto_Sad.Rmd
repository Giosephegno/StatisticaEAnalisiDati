...
```{r fig.align = 'center'}
p7 <- ggplot(mpg, aes(x = year)) + geom_bar(fill = "white", col = "black")
...
All'aumentare del numero dei cilindri aumenta il consumo di carburante in città, infatti auto a 4 cilindri in media fanno più miglia per gallone rispetto alle auto con 8 cilindri.
